...
var defaults = { width: 200, height: 50, colour: '663399' };
...
http.createServer(function (req, res) {
  ...
  var svg = '<svg xmlns="http://www.w3.org/2000/svg" width="'+width+'" height="'+height+'"><g>'+
              ...
              '<text y="50%" x="50%" text-anchor="middle" dominant-baseline="central" style="font-family: sans-serif; font-size: '+Math.ceil(height/4)+'px; fill:#'+textColour+'">'+width+'x'+height+'</text>' +
            '</g></svg>';
